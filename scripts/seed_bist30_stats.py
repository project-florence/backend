...
Tek seferlik kurulum scriptidir. Organik kullanıcı olmadığında popüler
sıralamada BIST30'ların önde görünmesini sağlar.
...
if __name__ == "__main__":
    ...
    asyncio.run(seed(boost=args.boost))
